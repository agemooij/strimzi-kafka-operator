...
public class EntityOperatorTest {
    ...
    public void testGenerateDeployment() {
        ...
        Deployment dep = entityOperator.generateDeployment(Collections.EMPTY_MAP, true);
    ...
    public void withAffinity() throws IOException {
        helper.assertDesiredResource("-Deployment.yaml", zc -> zc.generateDeployment(Collections.emptyMap(), true).getSpec().getTemplate().getSpec().getAffinity());
    }
